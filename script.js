...
async function predictModel(xs){
    ...
    for(let i = 0 ;i < 10; i++){
        ...
        if(highestScore[1] === i) {
            document.getElementsByClassName("result")[i].style.color="#2192FF";
            document.getElementsByClassName("result")[i].style.border = 'solid 2px #2192FF'
        }
        else {
...
document.getElementById('btn').onclick = function(){
    for(let i = 0 ;i < 10; i++){
        document.getElementsByClassName("result")[i].style.color="#FF6D28";
        document.getElementsByClassName("result")[i].style.border = 'solid 1px #FF6D28'
    }
  guessImage();
